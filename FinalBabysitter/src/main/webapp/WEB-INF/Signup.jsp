...
<body>
  ...
  <form action="signup_as_cus" method="get">

<div class="split left">
  <div class="centered"><img src='<c:url value="/resources/images/babysitterpara.jpg"> </c:url>'>
    <button>Signup as Parent/Customer</button>
  </div>
</div>
</form>
    <form action="signup_as_sitter" method="get">
<div class="split right">
  <div class="centered">
    <img src='<c:url value="/resources/images/babysitter.jpg" > </c:url>'>
    
    <button>Signup as babysitter</button>
  </div>
</div>
   </form>   
</body>
